...
//Modify: rsicv on VCU1525
#define DTMCONTROL                  (3)<<12+(9)<<6+9
...
uint8_t ir_dtmcontrol[4] = {0x49,0x32,0x00,0x00};
struct scan_field select_dtmcontrol = {
	.in_value = NULL,
	.out_value = ir_dtmcontrol
};
//uint8_t ir_dbus[1] = {DBUS};
uint8_t ir_dbus[4] = {0x49,0x22,0x02,0x00};
struct scan_field select_dbus = {
	.in_value = NULL,
	.out_value = ir_dbus
};
//uint8_t ir_idcode[1] = {0x1};
uint8_t ir_idcode[4] = {0x49,0x92,0x00,0x00};
