...
{
	static uint8_t ir_dmi[4] = {DTM_DMI&0xFF, (DTM_DMI&0xFF00)>>8, (DTM_DMI)>>16};
...
//	LOG_INFO("address_in  = %08x", (address_in==NULL)? 0: *address_in );
//	LOG_INFO("data_in     = %08x", (data_in==NULL)?0:*data_in    );
//	LOG_INFO("op          = %d"  ,  op         );
//	LOG_INFO("address_out = %08x",  address_out);
//	LOG_INFO("data_out    = %08x",  data_out   );
